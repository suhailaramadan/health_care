...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "تسجيل الدخول",
                  style: getBoldStyle(
                      fontSize: FontSize.s22, color: ColorManager.primary),
                ),
              ),
            ],
          ),
    ...
    //     if ((userType == "User" && roleFromApi != "User")) {
    //       UIUtils.showMessage(
    //           context, "غير مصرح لك بتسجيل الدخول ك طالب", ColorManager.red);
    //       _emailController.clear();
    //       _passwordController.clear();
    //       return;
    //     }
    //     if ((userType == "Doctor" && roleFromApi != "Doctor")) {
    //       UIUtils.showMessage(
    //           context, "غير مصرح لك بتسجيل الدخول كـ دكتور", ColorManager.red);
    //       _emailController.clear();
    //       _passwordController.clear();
    //       return;
    //     }
    ...
    //                         password: _passwordController.text));
    //                     SharedPrefHandel.saveToken(
    //                         CacheConstants.tokenKey, CacheConstants.roleKey);
    //                   }
    //                 },
    //               ),
    //             ),
