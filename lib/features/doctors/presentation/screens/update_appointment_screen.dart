...
//   static const updateAppointment = "/updateAppointmet";
//   DoctorsAppointmentModel appointment;

//   UpdateAppointmentScreen({super.key, required this.appointment});
...
//                   labelText: "وقت البداية", hintText: "اختر وقت البدء"),
//             ),
//             const SizedBox(height: 16),
//             TextField(
...
//               decoration: const InputDecoration(
//                   labelText: "وقت النهاية", hintText: "اختر وقت الإنتهاء"),
//             ),
//             const SizedBox(height: 16),
//             TextField(
...
//             BlocBuilder<UpdateAppointmentCubit, AppointmentStates>(
...
//                   label: "تحديث الموعد",
//                   onTap: () {
//                     context.read<UpdateAppointmentCubit>().updateAppointment(
...
//                         //widget.appointmentId: widget.appointment.id!,
//                         // day: selectedDay,
//                         // startTime: startTimeController.text,
//                         // endTime: endTimeController.text,
